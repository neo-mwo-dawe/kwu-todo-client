// =============================================================
//  AddTodoForm.Designer.cs — Visual Studio 디자이너 자동 생성 영역
//  · 도구상자에서 컨트롤을 추가하거나 속성 편집 시 이 파일이 자동 갱신됨
//  · 동작/이벤트는 AddTodoForm.cs 에 작성
// =============================================================
// [신규] 원본 TodoForm 을 Add/Edit 두 폼으로 분리하면서 새로 생성된 디자이너 파일.
//        제목/마감일/우선순위 라디오/카테고리/팀 과제 컨트롤 + 도구상자 컴포넌트 다수 포함.
...
namespace KwuTodoAI
{
    partial class AddTodoForm
    {
        ...
        private ToolStripMenuItem  ctxClear           = null!;
        ...
        private void InitializeComponent()
        {
            ...
            toolTip.SetToolTip(txtTitle,    "할 일의 제목을 입력하세요 (최대 200자)");
            toolTip.SetToolTip(dtpDueDate,  "마감일을 선택하세요");
            toolTip.SetToolTip(chkNoDue,    "마감일을 설정하지 않으려면 체크");
            ...
            toolTip.SetToolTip(btnSave,     "TODO를 서버에 저장합니다");
            ...
            ctxClear.Size = new Size(140, 22);
            ctxClear.Text = "내용 지우기";
            ctxMenu.Items.AddRange(new ToolStripItem[] { ctxClear });
            ctxMenu.Name = "ctxMenu";
            ctxMenu.Size = new Size(141, 26);
